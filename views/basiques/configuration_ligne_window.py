...
class ConfigurationLigneWindow(QWidget):
    def __init__(self, save_configuration_callback=None):
        super().__init__()

        self.setWindowTitle("Configuration de l'API en Ligne")
        ...
        # Champ pour le jeton de l'API
        self.api_token_input = QLineEdit()
        self.api_token_input.setPlaceholderText("Entrez le jeton d'identification (token)")
        self.layout().addWidget(QLabel("Jeton d'identification :"))
        self.layout().addWidget(self.api_token_input)
